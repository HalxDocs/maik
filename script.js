...
// For mobile responsiveness - adjust toggle position
function adjustTogglePosition() {
    ...
    if (window.innerWidth <= 768) {
        // On mobile, move toggle next to hamburger
        headerContainer.insertBefore(themeToggle, hamburger.nextSibling);
    } else {
        // On desktop, move toggle to the end of header container
